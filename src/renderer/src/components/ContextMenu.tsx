 ...
 * inside precisely there. The submenu then opened entirely off-screen, which made the rating
 ...
 * hovering a row inside a submenu — a star in the rating menu, say — set the shared value to "no
